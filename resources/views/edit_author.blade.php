            ...
            <div class="col-md-5">
                ...
                <form action="{{route('update.author',$author['id'])}}" method="post">
                    ...
                    <div class="mb-3 form-floating birthday_width">
                        <input type="date" class="form-control" id="birthday" name="birthday" placeholder="Umberto Eco" value="{{$author['birthday']}}">
                        <label for="birthday">Data di Nascita (opzionale)</label>

                    </div>

                    <div class="pt-4 border-top">
                        <button type="submit" class="btn btn-primary me-3">Aggiorna l'Autore</button>
